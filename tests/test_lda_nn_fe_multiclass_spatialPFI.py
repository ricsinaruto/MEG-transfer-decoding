...
# load loss files
directory = os.path.join('results_test', 'lda_nn', 'subj0', 'spatialPFI')

path = os.path.join(directory, 'val_loss_PFIclosest1.npy')
pfi = np.load(path)

# load true pfi
path = os.path.join('tests', 'results', 'lda_nn', 'subj0', 'spatialPFI')
path = os.path.join(path, 'val_loss_PFIclosest1.npy')
