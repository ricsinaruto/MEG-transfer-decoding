...
from classifiers_linear import LDA, LDA_average, LDA_cov, LDA_cov_sid
...
from cichy_data import CichyData, CichyContData, CichySimpleContData, CichyDataCrossval
from cichy_data import CichyDataCrossvalRobust, CichyDataRobust
